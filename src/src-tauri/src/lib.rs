...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::confero::confero_test_connection,
            commands::confero::confero_push_books,
            commands::confero::confero_pull_books,
            commands::confero::confero_push_series,
            commands::confero::confero_pull_series,
            commands::confero::confero_full_sync,
