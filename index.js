...
var CosmicComicsTempI = CosmicComicsTemp;
...
function OpenTempDirectory() {
    shell.openPath(CosmicComicsTempI).then(r => console.log("opened : ", r));
}

//Open the Appdata folder
function OpenAppDataFolder() {
    shell.openPath(CosmicComicsData).then(r => console.log("opened : ", r));
}
...
async function downloader() {
    ...
    for (let i = 0; i < img2DL.length; i++) {
        ...
        document.getElementById("prgsDL").style.width =
            (i * 100) / (img2DL.length - 1) + "%";
